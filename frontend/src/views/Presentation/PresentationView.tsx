            ...
            <Box sx={{ textAlign: "left", margin: "20px" }}>
              <ul>
                ...
                <li>
                  Vue js:
                  <p>
                    I mostly use VueJs at <a href="https://github.com/kuzzleio/kuzzle">Kuzzle</a> to create a custom like grafana dashboard to retrieve IoT data.
                  </p>
                </li>
                <li>
                  React js:
            ...
            <Box sx={{ textAlign: "left", margin: "20px" }}>
              <ul>
                ...
                <li>
                  Docker:
                  <p>
                    I use docker a lot, I made a lot of docker images that you can find <a href="https://hub.docker.com/u/thomasmauran">here</a> they are mostly used for my project and generated by github actions.
                  </p>
                </li>
                <li>
                  Grafana:
